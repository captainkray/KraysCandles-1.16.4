...
public class RayTraceHelper {
    ...
    public static BlockTrace RayTraceBlock(World world, PlayerEntity player, int maxDistance) {
        ...
        ItemUseContext itemUseContext = new ItemUseContext(player, Hand.MAIN_HAND, rayTrace);
