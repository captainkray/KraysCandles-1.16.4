...
public class EntityVampire extends MonsterEntity {
    ...
    private static final DataParameter<String> PLAYER_NAME = EntityDataManager.createKey(EntityVampire.class, DataSerializers.STRING);

    public EntityVampire(EntityType<? extends MonsterEntity> type, World world) {
        super(type, world);
    }

    public EntityVampire(EntityType<? extends MonsterEntity> type, World world, String playerName, double x, double y, double z) {
        super(type, world);
