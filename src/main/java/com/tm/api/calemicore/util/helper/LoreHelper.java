...
public class LoreHelper {
    ...
    public static void addInformationLore (List<ITextComponent> tooltip, String lore, boolean isFirst) {
        ...
        else if (isFirst) tooltip.add(new StringTextComponent(getPlateText("Shift", TextFormatting.AQUA) + TextFormatting.GRAY + " Info"));
    }
    ...
    public static void addControlsLore (List<ITextComponent> tooltip, String lore, Type type, boolean isFirst) {
        ...
        else if (isFirst) tooltip.add(new StringTextComponent(getPlateText("Ctrl", TextFormatting.AQUA) + TextFormatting.GRAY + " Controls"));
    }
