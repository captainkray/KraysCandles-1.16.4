        ...
        if (location.getTileEntity() != null && location.getTileEntity() instanceof TileEntityCandleMount) {
            ...
            if (!mount.getCandleStack().isEmpty()) {
                ...
                if (heldStack.isEmpty()) {
                    ...
                    mount.setSoul("", "");
                    SoundHelper.playSoundAtLocation(location, SoundEvents.ENTITY_ITEM_FRAME_REMOVE_ITEM, SoundCategory.BLOCKS, 1, 1);
                ...
                heldStack.shrink(1);
                SoundHelper.playSoundAtLocation(location, SoundEvents.ENTITY_ITEM_FRAME_ADD_ITEM, SoundCategory.BLOCKS, 1, 1);
                return ActionResultType.SUCCESS;
            }
        }
