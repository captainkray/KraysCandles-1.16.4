...
import com.tm.krayscandles.block.BlockLanternSoulTrappedItem;
...
public abstract class BlockCandleBase extends BlockBase implements ITileEntityProvider, IRitualItem {
        ...
        if (!location.getBlockState().get(LIT)) {
            ...
            if (flintAndSteel || lantern || soulLantern || trappedSoulLantern) {
                ...
                if (flintAndSteel) {
                    ...
                    SoundHelper.playSoundAtLocation(location, SoundEvents.ITEM_FLINTANDSTEEL_USE, SoundCategory.PLAYERS, 1, 1);
                }
                    ...
                    SoundHelper.playSoundAtLocation(location, SoundEvents.ITEM_FIRECHARGE_USE, SoundCategory.PLAYERS, 1, 1);
                }
            }
    ...
    public static void extinguishCandle(Location location) {
        ...
        if (location.getBlockState().get(LIT)) {
            ...
            attachSoul(location, "", "");
            SoundHelper.playSoundAtLocation(location, SoundEvents.BLOCK_FIRE_EXTINGUISH, SoundCategory.PLAYERS, 1, 2);
        }
    }
